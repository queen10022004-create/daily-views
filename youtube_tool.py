...
if __name__ == "__main__":
    # 1. Lấy API Key từ biến môi trường (Environment Variable)
    # GitHub Actions sẽ tự động bơm Key vào đây lúc chạy
    API_KEY = os.environ.get('API_KEY') 

    if not API_KEY:
        print("❌ LỖI: Chưa tìm thấy API Key. Hãy kiểm tra lại cài đặt Secrets trên GitHub.")
        exit(1)
    
    # 2. Cấu hình kênh muốn quét
